...
__carts__ on some kind of rudimentary system of tracks they've come up with.
...
Several __carts__ are also on the tracks. Carts always face either up (`^`),
...
turns __left__ the first time, goes __straight__ the second time, turns
__right__ the third time, and then repeats those directions starting again with
__left__ the fourth time, __straight__ the fifth time, and so on. This process
...
time. They do this based on their __current location__: carts on the top row
...
moved one step, the process repeats; each of these loops is called a __tick__.
...
To help prevent crashes, you'd like to know __the location of the first crash__.
