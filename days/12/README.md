...
(`#`) or do not (`.`) currently contain a plant, the __initial state__. (No
...
has been trying to figure out how these plants __spread__ to nearby pots. Based
...
determining what will happen after __`20` generations__.
...
__After `20` generations, what is the sum of the numbers of all pots which contain
a plant?__
