...
guard post! They've been writing down the ID of __the one guard on duty that
night__ - the Elves seem to have decided that one guard was enough for the
...
__Strategy 1:__ Find the guard that has the most minutes asleep. What minute
...
(10+10+10). __Guard #10 was asleep most during minute 24__ (on two days, whereas
...
__Strategy 2:__ Of all guards, which guard is most frequently asleep on the same
minute?

In the example above, Guard __#99__ spent minute __45__ asleep more than any
